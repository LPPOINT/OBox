...
namespace Assets.Scripts.Camera
{
    public class CameraFade : MonoBehaviour
    {
        ...
        /// Fade duration.
        /// </param>
        public static void Fade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration)
        {
        ...
        /// Fade delay.
        /// </param>
        public static void Fade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, float fadeDelay)
        {
            if (fadeDuration <= 0.0f)
            {
                SetScreenOverlayColor(newScreenOverlayColor);
        ...
        /// </param>
        public static void Fade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, float fadeDelay, Action OnFadeFinish)
        {
            if (fadeDuration <= 0.0f)
            {
                SetScreenOverlayColor(newScreenOverlayColor);
        ...
        public static void FadeIn(Action onFinish)
        {
            Fade(Color.black, true, 2f, 0, onFinish);
        }

        public static void FadeOut(Action onFinish)
        {
            Fade(Color.white, false, 1f, 0, onFinish);
        }
        public static void FadeOut(Color color, Action onFinish)
        {
            Fade(color, false, 1f, 0, onFinish);
        }
        public static void FadeOut(Color color, float time, Action onFinish)
        {
            Fade(color, false, time, 0, onFinish);
        }


        public static void FadeOut(float time, Action onFinish)
        {
            Fade(Color.white, false, time, 0, onFinish);
        }
